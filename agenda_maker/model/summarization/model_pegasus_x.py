...
class Pegasus_X(BaseModel):
    model_name = "model_pegasusx"

    def set_params(self) -> None:
        self.model_type = (
            self.config_manager.config.model.summarization.pegasus_x.model_type
        )
        self.tokenizer_type = (
            self.config_manager.config.model.summarization.pegasus_x.tokenizer_type
        )
        self.min_length = (
            self.config_manager.config.model.summarization.pegasus_x.min_length
        )
        self.max_length = (
            self.config_manager.config.model.summarization.pegasus_x.max_length
        )
        self.min_length = (
            self.config_manager.config.model.summarization.pegasus_x.min_length
        )
        self.use_first = (
            self.config_manager.config.model.summarization.pegasus_x.use_first
        )
        self.num_beams = (
    ...
    def build_model(self) -> None:
        ...
        self.model = PegasusXForConditionalGeneration.from_pretrained(
            self.model_type
        ).to(self.device)
